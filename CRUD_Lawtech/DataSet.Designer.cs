...
namespace CRUD_Lawtech {
    ...
    public partial class DataSet : global::System.Data.DataSet {
        ...
        public partial class usuariosDataTable : global::System.Data.TypedTableBase<usuariosRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public usuariosRow AddusuariosRow(string nomeCompleto, string cpf, string email, System.DateTime dataCadastro, System.DateTime dataAlteracao) {
...
namespace CRUD_Lawtech.DataSetTableAdapters {
    ...
    public partial class usuariosTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[usuarios] ([nomeCompleto], [cpf], [email], [dataCadastro], [dataAlteracao]) VALUES (@nomeCompleto, @cpf, @email, @dataCadastro, @dataAlteracao);
SELECT id, nomeCompleto, cpf, email, dataCadastro, dataAlteracao FROM usuarios WHERE (id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[usuarios] SET [nomeCompleto] = @nomeCompleto, [cpf] = @cpf, [email] = @email, [dataCadastro] = @dataCadastro, [dataAlteracao] = @dataAlteracao WHERE (([id] = @Original_id) AND ((@IsNull_nomeCompleto = 1 AND [nomeCompleto] IS NULL) OR ([nomeCompleto] = @Original_nomeCompleto)) AND ((@IsNull_cpf = 1 AND [cpf] IS NULL) OR ([cpf] = @Original_cpf)) AND ((@IsNull_email = 1 AND [email] IS NULL) OR ([email] = @Original_email)) AND ((@IsNull_dataCadastro = 1 AND [dataCadastro] IS NULL) OR ([dataCadastro] = @Original_dataCadastro)) AND ((@IsNull_dataAlteracao = 1 AND [dataAlteracao] IS NULL) OR ([dataAlteracao] = @Original_dataAlteracao)));
SELECT id, nomeCompleto, cpf, email, dataCadastro, dataAlteracao FROM usuarios WHERE (id = @id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, nomeCompleto, cpf, email, dataCadastro, dataAlteracao FROM dbo.usuario" +
                "s";
